...
// Remove guests from list one at a time until only two names remain in your list
...
// Print your list to make sure you actually have an empty list at the end of program
console.log(names);
